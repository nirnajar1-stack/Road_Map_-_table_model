...
type ViewMode = "timeline" | "stages" | "vertical" | "schema";
...
export default function ProjectPage({
  ...
  return (
    <div className="min-h-screen bg-theme-page">
      ...
      <main
        className={
          viewMode === "timeline" || viewMode === "schema"
            ? "w-full py-8"
          ...
          <section className="mb-12 w-full">
            <div className="px-6 lg:px-10 xl:px-14 mb-6">
              ...
              <p className="text-sm text-theme-muted mt-2 max-w-2xl">
                תרשים ER עם גריד כהה, טבלאות בתלת-מימד, קווי חיבור, הודעות ומדיניות RLS
              </p>
            </div>
